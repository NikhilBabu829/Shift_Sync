...
// Stores the AI conversation history for a single staff member's chat session
const ChatSessionSchema = new Schema({
    staffMember : {type : Schema.Types.ObjectId, ref : 'Staff', required : true}, // owner of the session
    messages : [
        {
